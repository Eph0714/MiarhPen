...
final transactionsFilteredProvider = StreamProvider.autoDispose
  ...
  return DbChangeNotifier.instance
    ...
    final results = await dao.getFiltered(
      ...
      incomeCategoryId:
          filter.type == TransactionType.income ? filter.categoryId : null,
      expenseCategoryId:
          filter.type == TransactionType.expense ? filter.categoryId : null,
      type: filter.type,
...
final transactionByIdProvider =
    StreamProvider.autoDispose.family<TransactionEntry?, int>((ref, id) {
  final dao = ref.watch(transactionDaoProvider);
  return DbChangeNotifier.instance
